...
namespace StarlightRiver
{
    public partial class StarlightRiver : Mod 
    {
        private void CallBossChecklist()
        {
            ...
            bcl.Call("AddBoss", 2.6f, ModContent.NPCType<NPCs.Boss.SquidBoss.SquidBoss>(), this, "Auroracle", (Func<bool>)(() => StarlightWorld.SquidBossDowned), ModContent.ItemType<Items.Permafrost.SquidBossSpawn>(), SquidBossCollection, SquidBossLoot, SquidBossInfo, null, "StarlightRiver/NPCs/Boss/SquidBoss/BodyPreview");
