...
namespace StarlightRiver
{
    public partial class StarlightRiver : Mod
    {
        private void CallBossChecklist()
        {
            ...
            bcl.Call("AddBoss", 2.6f, ModContent.NPCType<StarlightRiver.Content.Bosses.SquidBoss.SquidBoss>(), this, "Auroracle", (Func<bool>)(() => StarlightWorld.HasFlag(WorldFlags.SquidBossDowned)), ModContent.ItemType<SquidBossSpawn>(), SquidBossCollection, SquidBossLoot, SquidBossInfo, null, "StarlightRiver/NPCs/Boss/SquidBoss/BodyPreview");
            ...
            bcl.Call("AddBoss", 3.9f, ModContent.NPCType<StarlightRiver.Content.Bosses.GlassBoss.VitricBoss>(), this, "Ceiros", (Func<bool>)(() => StarlightWorld.HasFlag(WorldFlags.GlassBossDowned)), ModContent.ItemType<Items.Vitric.GlassIdol>(), vitricBossCollection, vitricBossLoot, vitricBossInfo, null, "StarlightRiver/Bosses/GlassBoss/Preview");
        }
    }
}
