    ...
    public partial class StarlightWorld : ModWorld
    {
        public override void ModifyWorldGenTasks(List<GenPass> tasks, ref float totalWeight)
        {
            ...
            if (ShiniesIndex != -1)
            {
                ...
                tasks.Insert(DesertIndex + 3, new PassLegacy("Starlight River Vitric Desert", VitricGen));
                tasks.Insert(DesertIndex + 4, new PassLegacy("Starlight River Overgrowth", OvergrowGen));
                tasks.Insert(DesertIndex + 5, new PassLegacy("Starlight River Codex", GenHelper.BookAltarGen));
