...
namespace StarlightRiver.Core.Systems
{
	internal class DebugSystem : ModSystem
	{
		...
		{
			Terraria.On_Main.Update += DoUpdate;
			Terraria.On_Main.DrawInterface += DrawDebugMenu;
		}

		private void DrawDebugMenu(Terraria.On_Main.orig_DrawInterface orig, Main self, GameTime gameTime)
		{
			orig(self, gameTime);
		...
		private void DoUpdate(Terraria.On_Main.orig_Update orig, Main self, GameTime gameTime)
		{
