	...
	public partial class StarlightWorld : ModSystem
	{
		public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight)
		{
			...
			if (ShiniesIndex != -1)
			{
				...
				tasks.Insert(DesertIndex + 5, new PassLegacy("Starlight River Shrines", ShrineGen));
				tasks.Insert(DesertIndex + 6, new PassLegacy("Starlight River Artifacts", ArtifactGen));
