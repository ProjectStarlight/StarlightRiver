...
namespace StarlightRiver.Content.Tiles.AstralMeteor
{
	public class AluminumBrick : ModTile
    {
        ...
        public override void SetDefaults() =>
            this.QuickSet(0, DustType<Dusts.Electric>(), SoundID.Tink, new Color(156, 172, 177), ItemType<AluminumBrickItem>(), true, true, "Aluminum Brick");
    ...
    {
        public AluminumBrickItem() : base("Astral Aluminum Brick", "", "AluminumBrick", ItemRarityID.White, AssetDirectory.AluminumTile) { }  //TODO: Fix place type
