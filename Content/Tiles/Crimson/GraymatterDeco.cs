	...
	public class GraymatterDeco : SimpleTileLoader
	{
		...
		public override void Load()
		{
			LoadFurniture("GraymatterDeco1x4", "Gray Nerve (1x4)",
				new FurnitureLoadData(1, 4, 0, SoundID.Dig, false, new Color(167, 180, 191), false, false, "", TileHelper.AnchorFloor(1), anchorTiles: [ModContent.TileType<GrayMatter>()]));

			LoadFurniture("GraymatterDeco2x3", "Gray Nerve (2x3)",
				new FurnitureLoadData(2, 3, 0, SoundID.Dig, false, new Color(167, 180, 191), false, false, "", TileHelper.AnchorFloor(2), anchorTiles: [ModContent.TileType<GrayMatter>()]));

			LoadFurniture("GraymatterDeco2x2", "Gray Nerve (2x2)",
				new FurnitureLoadData(2, 2, 0, SoundID.Dig, false, new Color(167, 180, 191), false, false, "", TileHelper.AnchorFloor(2), anchorTiles: [ModContent.TileType<GrayMatter>()], variants: 2));

			LoadFurniture("GraymatterDeco1x2", "Gray Nerve (1x2)",
				new FurnitureLoadData(1, 2, 0, SoundID.Dig, false, new Color(167, 180, 191), false, false, "", TileHelper.AnchorFloor(1), anchorTiles: [ModContent.TileType<GrayMatter>()], variants: 2));

			LoadFurniture("GraymatterDeco3x3", "Gray Nerve (3x3)",
				new FurnitureLoadData(3, 3, 0, SoundID.Dig, false, new Color(167, 180, 191), false, false, "", TileHelper.AnchorFloor(3), anchorTiles: [ModContent.TileType<GrayMatter>()]));

			LoadFurniture("GraymatterDeco1x1", "Gray Nerve (1x1)",
				new FurnitureLoadData(1, 1, 0, SoundID.Dig, false, new Color(167, 180, 191), false, false, "", TileHelper.AnchorFloor(1), anchorTiles: [ModContent.TileType<GrayMatter>()], variants: 2));
		}
