	...
	public class TempleDecoration : SimpleTileLoader
	{
		...
		public override void Load()
		{
			...
			LoadFurniture("TempleChair", "Temple Chair",
				new FurnitureLoadData(1, 2, 0, SoundID.Dig, false, new Color(140, 97, 86), false, false, "Chair", TileHelper.AnchorFloor(1), faceDirection: true));

			LoadFurniture("TempleLargeVase", "Temple Large Vase",
				new FurnitureLoadData(2, 3, 0, SoundID.Dig, false, new Color(140, 97, 86), false, false, "Large Vase", TileHelper.AnchorFloor(2)));

			LoadFurniture("TempleLargeVaseCrystal", "Temple Large Crystal Vase",
				new FurnitureLoadData(2, 3, 0, SoundID.Dig, false, new Color(140, 97, 86), false, false, "Large Vase", TileHelper.AnchorFloor(2)));

			LoadFurniture("TempleWorkbench", "Temple Workbench",
				new FurnitureLoadData(2, 1, 0, SoundID.Dig, false, new Color(140, 97, 86), true, false, "Workbench", TileHelper.AnchorFloor(2)));

			LoadFurniture("TempleThrone", "Temple Throne",
				new FurnitureLoadData(2, 3, 0, SoundID.Dig, false, new Color(140, 97, 86), false, false, "Throne", TileHelper.AnchorFloor(2)));

			LoadFurniture("TempleFloorWeaponRack", "Temple Floor Weapon Rack",
				new FurnitureLoadData(3, 4, 0, SoundID.Dig, false, new Color(140, 97, 86), false, false, "Weapon Rack", TileHelper.AnchorFloor(3)));

			LoadFurniture("TempleTable", "Temple Table",
				new FurnitureLoadData(3, 2, 0, SoundID.Dig, false, new Color(140, 97, 86), true, false, "Table", TileHelper.AnchorFloor(3)));

			LoadFurniture("TempleTableCrystal", "Temple Crystal Table",
				new FurnitureLoadData(3, 2, 0, SoundID.Dig, false, new Color(80, 131, 142), true, false, "Table", TileHelper.AnchorFloor(3)));
			...
			LoadFurniture("TempleThingamajig", "Temple Large Weapon Rack",
				new FurnitureLoadData(4, 3, 0, SoundID.Dig, false, new Color(140, 97, 86), false, false, "Weapon Rack", TileHelper.AnchorFloor(4), faceDirection: true));
		}
	}
}