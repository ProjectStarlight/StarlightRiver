...
namespace StarlightRiver.Content.Tiles.Vitric
{
	internal class SandstoneDoor : ModTile
	{
		...
		{
			this.QuickSetFurniture(8, 2, DustID.Stone, SoundID.Tink, false, new Color(130, 85, 45));
		}

		public override void NearbyEffects(int i, int j, bool closer)
		{
			if (StarlightWorld.HasFlag(WorldFlags.DesertOpen) && !Main.npc.Any(n => n.type == NPCType<Bosses.VitricBoss.VitricBoss>() && n.active))
