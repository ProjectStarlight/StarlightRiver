...
namespace StarlightRiver.Content.Tiles.Overgrow
{
    ...
    internal class BulbFruitDummy : Dummy
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D tex2 = GetTexture(Directory.OvergrowTileDir + "BulbFruit"); //Draws the bulb itself
            ...
            for (int k = 2; k <= 30; k++) //Draws the vine
            {
                ...
                Texture2D tex = GetTexture(Directory.OvergrowTileDir + "VineOvergrowFlow");
