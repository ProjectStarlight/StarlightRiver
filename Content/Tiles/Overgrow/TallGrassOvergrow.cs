...
namespace StarlightRiver.Content.Tiles.Overgrow
{
	internal class TallgrassOvergrow : ModTile
    {
        ...
        {
            spriteBatch.Draw(Request<Texture2D>("StarlightRiver/Assets/Tiles/Overgrow/TallgrassOvergrowFlow").Value, new Rectangle((i + (int)Helper.TileAdj.X) * 16 - (int)Main.screenPosition.X + 8,
