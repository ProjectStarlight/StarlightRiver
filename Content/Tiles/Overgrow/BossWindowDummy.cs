...
namespace StarlightRiver.Content.Tiles.Overgrow
{
    internal class BossWindowDummy : Dummy, IMoonlordLayerDrawable
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D frametex = GetTexture(Directory.OvergrowTile + "WindowFrame");
            Texture2D glasstex = GetTexture(Directory.OvergrowTile + "WindowGlass");
        ...
        public void DrawMoonlordLayer(SpriteBatch spriteBatch)
        {
            ...
            //background
            Texture2D backtex1 = GetTexture(Directory.OvergrowTile + "Window4");
            spriteBatch.Draw(backtex1, target, GetSource(0, backtex1), Color.White, 0, Vector2.Zero, 0, 0);


            Texture2D backtex2 = GetTexture(Directory.OvergrowTile + "Window3");
            spriteBatch.Draw(backtex2, target, GetSource(0.4f, backtex2), Color.White, 0, Vector2.Zero, 0, 0);


            Texture2D backtex3 = GetTexture(Directory.OvergrowTile + "Window2");
            ...
            for (int k = -2; k < 3; k++)
            {
                Texture2D tex2 = GetTexture(Directory.OvergrowTile + "PitGlow");
            ...
            {
                Texture2D watertex = GetTexture(Directory.OvergrowTile + "Waterfall");
            ...
            //front row
            Texture2D backtex4 = GetTexture(Directory.OvergrowTile + "Window1");
            ...
            {
                Texture2D walltex = GetTexture(Directory.OvergrowTile + "Dor2");
                Texture2D walltex2 = GetTexture(Directory.OvergrowTile + "Dor1");
