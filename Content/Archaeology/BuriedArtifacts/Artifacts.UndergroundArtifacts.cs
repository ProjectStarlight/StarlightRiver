...
namespace StarlightRiver.Content.Archaeology.BuriedArtifacts
{
    ...
    public class RuneOfUndoingArtifact : UndergroundArtifact
    {
        public override string TexturePath => AssetDirectory.Assets + "Items/Utility/RuneOfUndoing";

        public override Vector2 Size => new Vector2(26, 40);

        public override float SpawnChance => 0.75f;

        public override int SparkleDust => ModContent.DustType<Dusts.ArtifactSparkles.PurpleArtifactSparkle>();

        public override int SparkleRate => 40;

        public override Color BeamColor => Color.Purple;

        public override int ItemType => ModContent.ItemType<RuneOfUndoing>();
    }
}