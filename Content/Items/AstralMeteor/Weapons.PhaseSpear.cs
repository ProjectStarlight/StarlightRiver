...
namespace StarlightRiver.Content.Items.AstralMeteor
{
    internal abstract class Phasespear : ModItem
    {
        ...
        public override string Texture => Directory.AluminumItem + "Phasespear";
        ...
        {
            Texture2D tex = GetTexture(Directory.AluminumItem + "PhasespearGlow");
            Texture2D tex2 = GetTexture(Directory.AluminumItem + "PhasespearGlow2");
    ...
    internal abstract class PhasespearProjectile : SpearProjectile
    {
        ...
        public override string Texture => Directory.AluminumItem + "PhasespearProjectile";
        ...
        {
            Texture2D tex = GetTexture(Directory.AluminumItem + "PhasespearProjectileGlow");
            Texture2D tex2 = GetTexture(Directory.AluminumItem + "PhasespearProjectileGlow2");
