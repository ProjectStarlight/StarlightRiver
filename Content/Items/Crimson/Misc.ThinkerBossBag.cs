...
{
	class ThinkerBossBag : ModItem
	{
		public override string Texture => AssetDirectory.CrimsonItem + Name;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Treasure Bag (The Thinker)");
		...
		{
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<ImaginaryTissue>(), 1, 40, 50));
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<DendriteItem>(), 1, 100, 140));
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<MindCloak>(), 1, 1, 1));
		}
