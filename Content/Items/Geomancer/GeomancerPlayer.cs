...
namespace StarlightRiver.Content.Items.Geomancer
{
    ...
    public class GeomancerPlayer : ModPlayer
    {
        ...
        public override void OnHitNPCWithProj(Projectile proj, NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                Projectile.NewProjectile(player.Center + Main.rand.NextVector2Circular(50, 50), Vector2.Zero, ModContent.ProjectileType<RubyDagger>(), (int)(damage * 0.3f), knockback, player.whoAmI, target.whoAmI);
            }
        }
