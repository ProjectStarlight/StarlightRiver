...
namespace StarlightRiver.Content.Items.Manabonds
{
	internal class BasicManabond : Manabond
	{
		...
		public BasicManabond() : base("Manabond", "Your minions can store 50 mana\nYour minions siphon 6 mana per second from you untill full\nYour minions spend 10 mana to attack with a magic bolt occasionally") { }
		...
		{
			if (mp.timer % 60 == 0 && mp.mana >= 10 && mp.target != null)
			{
				mp.mana -= 10;
