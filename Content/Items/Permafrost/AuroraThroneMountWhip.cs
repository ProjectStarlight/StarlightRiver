...
namespace StarlightRiver.Content.Items.Permafrost
{
	public class AuroraThroneMountWhip : BaseWhip
	{
		...
		{
			On_Projectile.Colliding += SpecialWhipColission; //We need to use a custom hook here since vanilla oofs whip colission before tmods colliding hook can run.
		}
		...
		private bool SpecialWhipColission(On_Projectile.orig_Colliding orig, Projectile self, Rectangle myRect, Rectangle targetRect)
		{
