...
namespace StarlightRiver.Content.Bosses.SquidBoss
{
	public partial class SquidBoss : ModNPC
	{
		public void SpawnAnimation()
		{
			...
			if (GlobalTimer == 100)
			{
				string title = Main.rand.NextBool(10000) ? Language.GetTextValue("Mods.StarlightRiver.Custom.UI.MessageDisplay.AuroracleMessage0") : Language.GetTextValue("Mods.StarlightRiver.Custom.UI.MessageDisplay.AuroracleMessage1");
				UILoader.GetUIState<TextCard>().Display(NPC.FullName, title, null, 440);
