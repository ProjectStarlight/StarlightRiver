...
namespace StarlightRiver.Content.Bosses.GlassMiniboss
{
	public partial class Glassweaver : ModNPC
	{
		...
		{
			if (AttackTimer == 1)
				Main.NewText(GetWaveText("Wave2"), Color.OrangeRed);
		...
		{
			if (AttackTimer == 1)
				Main.NewText(GetWaveText("Wave3"), Color.OrangeRed);
		...
		{
			if (AttackTimer == 1)
				Main.NewText(GetWaveText("Wave4"), Color.OrangeRed);
		...
		{
			if (AttackTimer == 1)
				Main.NewText(GetWaveText("Wave5"), Color.OrangeRed);
		...
		{
			if (AttackTimer == 1)
				Main.NewText(GetWaveText("Wave6"), Color.OrangeRed);
		...
		{
			if (AttackTimer == 1)
				Main.NewText(GetWaveText("Wave7"), Color.OrangeRed);
