		...
		public override void AI()
		{
			...
			switch (phase)
			{
				...
				case 3: //falling for smash attack
					...
					if (tile.HasTile && Main.tileSolid[tile.TileType] && tile.BlockType == BlockType.Solid && tile.TileType != StarlightRiver.Instance.Find<ModTile>("VitricBossBarrier").Type && NPC.Center.Y > StarlightWorld.vitricBiome.Y * 16) //tile collision
						Impact();
