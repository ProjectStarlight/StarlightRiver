...
namespace StarlightRiver.Content.GUI
{
	public class CodexPopup : SmartUIState
	{
		...
		public override void Draw(SpriteBatch spriteBatch)
		{
			...
			var target = new Rectangle((int)(pos.X - 40 - 50), (int)(pos.Y - 25), (int)(stringWidth + 140), 40);
			Texture2D bgTex = TextureAssets.MagicPixel.Value;
			Texture2D edgeTex = Request<Texture2D>(AssetDirectory.GUI + "CodexPopupEdge").Value;
