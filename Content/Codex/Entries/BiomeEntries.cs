...
namespace StarlightRiver.Codex.Entries
{
    internal class PermafrostEntry : CodexEntry
    {
        public PermafrostEntry()
        {
            ...
            Image = GetTexture("StarlightRiver/Assets/Codex/Entries/BiomeImageAurora");
            Icon = GetTexture("StarlightRiver/Assets/Codex/Entries/BiomeIconAurora");
        }
    }
    ...
    internal class VitricEntry : CodexEntry
    {
        public VitricEntry()
        {
            ...
            Image = GetTexture("StarlightRiver/Assets/Codex/Entries/BiomeImageVitric");
            Icon = GetTexture("StarlightRiver/Assets/Codex/Entries/BiomeIconVitric");
        }
    }
    ...
    internal class OvergrowEntry : CodexEntry
    {
        public OvergrowEntry()
        {
            ...
            Image = GetTexture("StarlightRiver/Assets/Codex/Entries/BiomeImageOvergrow");
            Icon = GetTexture("StarlightRiver/Assets/Codex/Entries/BiomeIconOvergrow");
        }
    }
}