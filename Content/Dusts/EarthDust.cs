namespace StarlightRiver.Content.Dusts
{
	...
	public class Grass : ModDust
	{
		...
		public override bool Update(Dust dust)
		{
			...
			if (Player.ZoneSnow)
				dust.color = new Color(250, 250, 255);
			if (Player.ZoneDesert)
				dust.color = new Color(241, 228, 131);
			if (Player.ZoneJungle)
				dust.color = new Color(143, 215, 29);
			if (Player.ZoneGlowshroom)
				dust.color = new Color(63, 90, 231);
			if (Player.ZoneCorrupt)
				dust.color = new Color(186, 177, 243);
			if (Player.ZoneCrimson)
				dust.color = new Color(208, 80, 80);
			if (Player.ZoneHallow)
				dust.color = new Color(98, 213, 247);
