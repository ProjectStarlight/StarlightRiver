...
namespace StarlightRiver.Content.Dusts
{
    public static class SkullBusterDustColors
    {
        ...
        public static Color second = new Color(120, 130, 255);
        public static Color third = new Color(25,25,25);
    }
    ...
    public class SkullbusterDustTwo : ModDust
    {
    ...
    public class SkullbusterDustThree : ModDust
    {
    ...
    class SkullbusterDustFour : ModDust
    {
    ...
    public class SkullbusterDustFive : ModDust
    {
        public override string Texture => AssetDirectory.Dust + "NeedlerDust";
        public override void OnSpawn(Dust dust)
        {
