...
namespace StarlightRiver.Content.Abilities.ForbiddenWinds
{
	public class Dash : CooldownAbility, IOrderedLoadable
	{
		...
		public override string Tooltip => "Channel starlight to recreate the strange winds that fuel the bellows of the vitric forges, propelling yourself forward and smashing crystalline barriers. NEWBLOCK " +
