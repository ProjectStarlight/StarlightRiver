...
namespace StarlightRiver.Content.NPCs.Vitric
{
	class VitricNPCSpawner : PlayerTicker
	{
		...
		public override void Tick(Player player)
		{
			...
			{
				Point16 coords = Helpers.Helper.FindTile(((player.Center + Vector2.One.RotatedByRandom(6.28f) * Main.rand.NextFloat(200, 500)) / 16).ToPoint16(), n => !n.active() && n.liquidType() == 1 && n.liquid > 0, 10);
